...
<body <?php body_class(); ?>>
  <section class="container" style="max-width: 700px;">
    <header>
      ...
      <h1 class="mt-4 font-size-12">This is where we keep our nuts, bolts, xml & audio files. Please find our podcast feeds below—or find more content on our website.</h1>
    </header>
